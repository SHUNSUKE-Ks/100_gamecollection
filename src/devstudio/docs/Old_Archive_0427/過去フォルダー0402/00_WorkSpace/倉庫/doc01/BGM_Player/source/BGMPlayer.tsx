...
import type { BGMTrack } from './useBGMPlayer';
...
const styles = {
    ...
    backgroundOverlay: {
        ...
        inset: 0,
        //backgroundImage: 'url(/assets/bg_visual.jpg)', // NOTE: Add your background image here
...
export const BGMPlayer: React.FC<BGMPlayerProps> = () => {
    // NOTE: basePath can be passed here if different from default
